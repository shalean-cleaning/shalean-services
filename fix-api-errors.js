 ...
 * 
 * This script fixes the database schema mismatches that are causing 500 errors:
 * 1. Updates database types to match current schema
 * 2. Applies missing migrations
 * 3. Updates API code to use correct column names
 */

const fs = require('fs');
const path = require('path');

console.log('🔧 Fixing API 500 Errors...\n');

// 1. Update database types to match current schema
console.log('1. Updating database types...');
...
console.log('\n2. Creating migration for missing columns...');
...
const migrationPath = 'supabase/migrations/022_fix_api_500_errors.sql';
...
console.log('✅ Updated cleaners availability API');
...
console.log('✅ Updated bookings draft API');
